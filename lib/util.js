...
exports.BufferReader = buffers.BufferReader;
exports.BufferWriter = buffers.BufferWriter;
exports.GUID = buffers.GUID;
...
exports.find = function find(object, value, nonStrict) {
    for(var i in object)
        if(object[i] === value || nonStrict && object[i] == value)
            return i;
};
exports.findNumBase = function findNumBase(object, value) {
    var last;
    for(var i in object) {
        if(object[i] > value)
            return last;
